...
@SpringBootTest // 스프링 컨테이너를 띄워서 실제 스프링 환경에서 테스트한다.
@Transactional //테스트가 끝나면 롤백 해준다.
class MemberServiceIntegrationTest {

    @Autowired MemberService memberService;
    @Autowired MemberRepository memberRepository; //스프링은 필드 주입이 편하다.
